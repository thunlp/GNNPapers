...
1. **Amortized Variational Inference with Graph Convolutional Networks for Gaussian Processes.** AISTATS 2019. [paper](http://proceedings.mlr.press/v89/liu19c.html)
